...
export default function Footer() {
  return (
    <footer className="bg-charcoal-dark border-t border-zinc-800">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <a
                ...
                className="block text-gold hover:text-gold-light font-bold text-lg"
              >
                {COMPANY.phone}
              </a>
              <a
                href={`mailto:${COMPANY.email}`}
                className="block text-zinc-400 hover:text-gold transition-colors break-all"
              >
                {COMPANY.email}
              </a>
        ...
        <div className="border-t border-zinc-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <Link href="/contact" className="text-zinc-500 hover:text-gold transition-colors">
                Contact
              </Link>
